...
public class InventoryController {
    ...
    public ResponseEntity<ApiResponse<TripFullDTO>> createTrip(@Valid @RequestBody CreateTripDTO tripRequest) {
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to create trip. Please try again later."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<LocationDTO>> createLocation(
        ...
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to create location. Please try again later."));
        }
    }
        ...
        try {
            return inventoryService.updateTrip(tripRequest)
                    ...
                    .orElseGet(() -> ResponseEntity.status(404)
                            .body(ApiResponse.error("Trip not found with id: " + tripRequest.id())));
        } catch (Exception e) {
            log.error("Failed to update trip with id: {}", tripRequest.id(), e);
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to update trip. Please try again later."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<LocationDTO>> updateLocation(
        ...
        try {
            return inventoryService.updateLocation(locationRequest)
                    ...
                    .orElseGet(() -> ResponseEntity.status(404)
                            .body(ApiResponse.error("Location not found with id: " + locationRequest.id())));
        } catch (Exception e) {
            log.error("Failed to update location with id: {}", locationRequest.id(), e);
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to update location. Please try again later."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<TripFullDTO>> deleteTrip(@PathVariable int id) {
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to delete trip. Please try again later."));
        }
    }
    ...
    public ResponseEntity<ApiResponse<LocationDTO>> deleteLocation(@PathVariable int id) {
        try {
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.error("Failed to delete location. Please try again later."));
        }
    }
}
