...
| CU "Complejo"(nivel resumen) | Reserva de ticket (que incluye la verificación de la disponibilidad de asiento y de descuentos por beneficios sociales, e impresión de boleto en formato pdf), Cambio de día y horario de pasaje, y Administración de devolución |
